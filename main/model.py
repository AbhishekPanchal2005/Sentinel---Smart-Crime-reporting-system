...
def predict_crime_pattern(description):
    ...
    """
    patterns = [
        "Theft", "Assault", "Fraud", "Cyber Crime", "Domestic Violence", "Drug Abuse"
    ]
    # Simple dummy logic: choose random
    predicted_type = random.choice(patterns)
    confidence = round(random.uniform(0.75, 0.98), 2)
    return {"predicted_type": predicted_type, "confidence": confidence}
